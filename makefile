...
glipperus: main.o docklet.o menu.o stored_items.o key_grabber.o clipboard.o clip_item.o InfoWindow.o KonfigPath.o ConfigDialog.o ConfigWidget.o RuntimeSettings.o HelpWindow.o
	$(CC) $^ $(CFLAGS) $(LDFLAGS) -o $@

main.o: main.c docklet.h RuntimeSettings.h key_grabber.h stored_items.h clip_item.h clipboard.h KonfigPath.h config.h
docklet.o: docklet.c docklet.h RuntimeSettings.h menu.h config.h
